...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART1_MspInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = uGPRS_TX_Pin|uGPRS_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /* USER CODE END USART3_MspInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = uSlave_TX_Pin|uSlave_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /* USER CODE END USART6_MspInit 0 */
    ...
    PC7     ------> USART6_RX
    */
    GPIO_InitStruct.Pin = uMaster_TX_Pin|uMaster_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, uGPRS_TX_Pin|uGPRS_RX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, uSlave_TX_Pin|uSlave_RX_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PC7     ------> USART6_RX
    */
    HAL_GPIO_DeInit(GPIOC, uMaster_TX_Pin|uMaster_RX_Pin);
